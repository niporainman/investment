...
<?php include("page_header.php"); ?>
  ...
  <section class="section-b-space pt-0">
    <div class="custom-container container blog-page">
      <div class="row gy-4">
        <div class="col-xl-9 col-lg-8 ratio50_2">
          ...
          <?php $cat_id=1;
	$sql = "SELECT COUNT(id) FROM articles WHERE category = '$category_id_db' ORDER BY id DESC";
	...
	$sql = "SELECT * FROM articles WHERE category = '$category_id_db' ORDER BY id DESC $limit";
	$query = mysqli_query($con, $sql);
